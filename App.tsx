...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-brand-light selection:text-white">
      ...
      <footer className="bg-brand-dark text-white border-t border-white/10 py-12 px-6">
